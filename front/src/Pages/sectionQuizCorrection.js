...
import QuizCorrectitem from './Components/quizCorrectItem';
function SectionQuizCorrection({userId,isProf}){
            ...
            .then((response)=>{
                if(response.data){
                    ...
                    for(let q of response.data){
                        quests.push([<QuizCorrectitem qType={q.qType} questionPhrase={q.phrase} correctAnswers={q.correctAnswer} wrongAnswers={q.wrongAnswer}/>])
                    }
...
export default SectionQuizCorrection;